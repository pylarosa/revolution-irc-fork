...
class MessageStorageSerializer {
    ...
    MessageInfo deserializeMessage(MessageSenderInfo sender, Date date, String text,
        ...
        if (o != null && o.has(PROP_BATCH)) {
            // TODO: find the batch
        }
        return builder.build();
    }

    String serializeExtraData(MessageInfo info) {
    ...
    String serializeSenderInfo(MessageSenderInfo sender) {
    ...
    MessageSenderInfo deserializeSenderInfo(String serialized, UUID uuid) {
